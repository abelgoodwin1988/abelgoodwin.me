...
Interested in further developing technical skills in Data Engineering Domains including analytics as well as Full Stack Development.`,
    ...
    skills: [
        ...
        { name: 'Postgres', category: ['Database', 'ETL'] },
        { name: 'SQL Server', category: ['Database', 'ETL'] },
        { name: 'Advanced Querying', category: ['Database', 'ETL'] },
        { name: 'DDL', category: ['Database', 'ETL'] },
        { name: 'DML', category: ['Database', 'ETL'] },
        { name: 'DCL', category: ['Database', 'ETL'] },
        { name: 'T-SQL', category: ['Database', 'ETL'] },
        { name: 'PL/SQL', category: ['Database', 'ETL'] },
        { name: 'Microsoft Access', category: ['Database', 'ETL'] },
        { name: 'Microsoft Excel', category: ['Database', 'ETL'] },
        { name: 'Data Analysis', category: ['Database', 'ETL'] },
        { name: 'Power BI', category: ['Database', 'ETL'] },
        { name: 'SSIS', category: ['Database', 'ETL'] },
        { name: 'NoSQL', category: ['Database', 'ETL'] },
        { name: 'Mongo', category: ['Database', 'ETL'] },
        { name: 'MySQL', category: ['Database', 'ETL'] },
        { name: 'PIG', category: ['Database', 'ETL'] },
        { name: 'Data Modeling', category: ['Database', 'ETL'] },
        { name: 'Datawarehousing', category: ['Database', 'ETL'] },
        { name: 'Relation Database Design', category: ['Database', 'ETL'] },
        { name: 'Database Administration', category: ['Database', 'ETL'] },
        ...
        { name: 'Max OSX', category: ['Software Engineering'] },
        { name: 'Test Driven Development', category: ['Software Engineering'] },
        { name: 'AWS', category: ['Cloud', 'AWS'] },
        { name: 'AWS Core Services', category: ['Cloud', 'AWS'] },
        { name: 'RDS', category: ['Cloud', 'AWS'] },
        { name: 'CloudFormation', category: ['Cloud', 'AWS'] },
        { name: 'Database Migration Services', category: ['Cloud', 'AWS'] },
        { name: 'Quicksight', category: ['Cloud', 'AWS'] },
        { name: 'Cloud SQL', category: ['Cloud', 'GCP'] },
